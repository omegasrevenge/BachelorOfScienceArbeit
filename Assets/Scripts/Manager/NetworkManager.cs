...
public class NetworkManager : MonoBehaviour //Photon.MonoBehaviour
{
//	void OnGUI()
//	{
//		
...
//				PhotonNetwork.JoinOrCreateRoom(PhotonNetwork.GetRoomList()[0].name, new RoomOptions(), new TypedLobby());
//			else
//				PhotonNetwork.JoinOrCreateRoom("My New Room", new RoomOptions(){maxPlayers = 10}, new TypedLobby());
//		}
//	}
//	
//	void OnLeftLobby()
